...
var (
	...
	dictionaries = map[string]dictionary{
		...
		"be": {
			...
			SingleSelectHelp:          "[↑/↓ навігацыя, Enter — выбар, Q/Esc — выхад]",
			MultiSelectHelp:           "[↑/↓ навігацыя, прабел — выбар, Enter — пацвярджэнне, Q/Esc — выхад]",
			MultiSelectHelpSelectAll:  "[↑/↓ навігацыя, прабел — пераключыць усе, Enter — пацвярджэнне, Q/Esc — выхад]",

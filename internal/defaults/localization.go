...
var (
	...
	dictionaries = map[string]dictionary{
		...
		"en": {
			...
			SingleSelectHelp:                     "[↑/↓ navigate, →/Enter select, Q/←/Esc/Ctrl+C exit]",
		...
		"tr": {
			...
			SingleSelectHelp:                     "[↑/↓ gezin, →/Enter seç, Q/←/Esc/Ctrl+C çıkış]",
		...
		"be": {
			...
			SingleSelectHelp:                     "[← выхад, ↑/↓ навігацыя, →/Enter выбар, Q/Esc/Ctrl+C — выхад]",
		...
		"uk": {
			...
			SingleSelectHelp:                     "[↑/↓ навігація, →/Enter вибір, Q/←/Esc/Ctrl+C — вихід]",

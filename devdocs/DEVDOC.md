# Руководство разработчика Жива

Это руководство объясняет архитектуру Жива, жизненный цикл `Task`, возможности стилизации и то, как расширять фреймворк. Все ссылки и примеры кода соответствуют текущей кодовой базе.

- Корневая директория репозитория: `github.com/qzeleza/ziva`
...
Ключевые файлы:
- `common/task.go` – определяет интерфейс `Task`, используемый в Жива
...
- Использование в вашем приложении: выполните `go get github.com/qzeleza/ziva` и импортируйте нужные пакеты.

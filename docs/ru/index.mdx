---
title: "О пакете"
description: "Термос - мощная Go библиотека для создания интерактивных TUI приложений с богатой функциональностью"
---

# Добро пожаловать в Termos

**Термос** - это мощная Go библиотека для создания интерактивных терминальных пользовательских интерфейсов (TUI). Построенная на основе Bubble Tea, она предоставляет высокоуровневые компоненты для быстрого создания консольных приложений.
...
<CardGroup cols={2}>
  ...
  <Card title="Валидация" icon="shield-check" href="/ru/validation/overview">
    Встроенные валидаторы для email, IP, доменов, паролей и многого другого
  </Card>

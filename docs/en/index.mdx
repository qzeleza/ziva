---
title: "About"
description: "Termos - a powerful Go library for creating interactive terminal user interfaces (TUI). Built on top of Bubble Tea, it provides high-level components for quickly building console applications."
---
